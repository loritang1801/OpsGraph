...
- Current product API covers alert intake, incident list/workspace queries with embedded approval tasks, fact mutation, recommendation/comms decisions, incident-scoped approval-task read APIs, filtered comms draft queries, resolve/close, replay for incidents and replay cases, replay-case read/list APIs, replay-run and replay-report filtering by replay case, richer replay evaluation metrics, stable replay evaluation error codes, and workflow-backed incident response plus retrospective flows with persisted replay-case snapshots
