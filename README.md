...
- Current product API covers alert intake, incident list/workspace queries, fact mutation, recommendation/comms decisions, resolve/close, replay for incidents and replay cases, replay-case read/list APIs, and workflow-backed incident response plus retrospective flows with persisted replay-case snapshots
